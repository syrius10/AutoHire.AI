 ...
 * Calls AI model for personalized well-being recommendations.
 */
export const getWellBeingPlan = async (workHours, workload, jobSatisfaction, stressLevel) => {
  try {
    const response = await axios.post("http://localhost:5075/predict_well_being", {

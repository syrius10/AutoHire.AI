 ...
 */
export const calculateMilestonePayout = async (contract_value, completion_percentage, client_satisfaction_score) => {
  try {
    const response = await axios.post("http://localhost:5132/milestone-payout", {
      contract_value,

 ...
 */
export const generateEngagementEmail = async (candidateName, jobPreferences) => {
 ...
 */
export const sendEngagementEmail = async (candidateEmail, candidateName, jobPreferences) => {
    const emailBody = await generateEngagementEmail(candidateName, jobPreferences);

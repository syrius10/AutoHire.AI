...
const RecruiterMessaging = () => {
  ...
  const handleGenerateMessage = async () => {
    ...
    const generatedMessage = await generateRecruiterMessage(recruiterName, candidateName, jobTitle);
  ...
  return (
    <div className="p-6">
      ...
      <input type="text" placeholder="Candidate Name" onChange={(e) => setCandidateName(e.target.value)} />

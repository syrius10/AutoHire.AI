...
export default function CoverLetterDashboard() {
  ...
  const handleGenerateCoverLetter = async () => {
    const result = await fetchCoverLetter(candidateName, jobTitle, companyName, skills.split(","));
  ...
  return (
    <div>
      ...
      <textarea value={skills} onChange={(e) => setSkills(e.target.value)} placeholder="Your Skills (comma-separated)" />

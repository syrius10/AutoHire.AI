...
const VideoInterviewAnalysis = () => {
  ...
  return (
    <div className="p-6">
      ...
      <p>
        Upload an interview video and get AI-powered insights on candidate
        responses.
      </p>
      ...
      {analysisResult && (
        <div className="mt-4 p-4 border rounded bg-gray-100">
          ...
          <p>
            <strong>Confidence Level:</strong> {analysisResult.confidenceLevel}%
          </p>
          <p>
            <strong>Speech Clarity:</strong> {analysisResult.speechClarity}
          </p>
        </div>
      )}
    </div>

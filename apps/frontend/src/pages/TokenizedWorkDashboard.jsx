...
import {
  fetchUserBalance,
  assignTokens,
} from "../services/tokenizedWorkService";
    ...
    <div className="p-6">
      ...
      <div className="mt-4">
        ...
        <input
          ...
          onChange={(e) =>
            setWorkData({ ...workData, workHours: e.target.value })
          }
        />
        <input
          type="text"
          ...
          onChange={(e) =>
            setWorkData({ ...workData, projectComplexity: e.target.value })
          }
        />
        <input
          type="text"
          ...
          onChange={(e) =>
            setWorkData({ ...workData, skillLevel: e.target.value })
          }
        />
        <button

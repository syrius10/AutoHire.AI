    ...
    <div className="p-6">
      ...
      {complianceReport ? (
        <div className="mt-4 border p-4 rounded bg-gray-100">
          <p><strong>Compliance Status:</strong> {complianceReport.status}</p>
          <p><strong>Legal Risk Score:</strong> {complianceReport.riskScore}</p>
          <p><strong>Regulatory Flags:</strong> {complianceReport.flags.join(", ")}</p>
        </div>
      ) : (

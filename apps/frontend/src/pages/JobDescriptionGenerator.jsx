...
import { generateJodDescription, optimizeJobDescription } from "../services/jobDescriptionService";
...
const JobDescriptionGenerator = () => {
    ...
    return (
        <div className="p-6">
            <h2 className="text-2xl font-bold">AI-Powered Job Description Generator</h2>
            <input 
                type="text"
            ...
            <input
                ...
                className="border p-2 mt-4 w-full"
            />
            <button className="mt-4 px-4 py-2 bg-blue-600 text-white" onClick={handleGenerate}>
                Generate Job Description
            </button>
            {generatedDescription && (
                <>
                    <p className="mt-4">{generatedDescription}</p>
                    <button className="mt-4 px-4 py-2 bg-green-600 text-white" onClick={handleOptimize}>

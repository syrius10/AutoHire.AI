  ...
  return (
    <div className="p-6">
      <h2 className="text-2xl font-bold">
        🤖 Self-Aware AI Workforce Automation
      </h2>
      <div className="mt-4">
        <input
          type="number"
          ...
          onChange={(e) =>
            setMetrics({ ...metrics, systemLoad: e.target.value })
          }
        />
        <input
          type="number"
          ...
          onChange={(e) =>
            setMetrics({ ...metrics, errorRate: e.target.value })
          }
        />
        <input
          type="number"
          ...
          onChange={(e) =>
            setMetrics({ ...metrics, taskCompletion: e.target.value })
          }
        />
        <button
      ...
      {status && (
        <div className="mt-4 border p-4 rounded">
          <p>
            <strong>AI Automation Status:</strong> {status}
          </p>
        </div>
      )}
    </div>

...
import {
  ...
  createProposal,
  castVote,
} from "../services/smartVotingService";
    ...
    <div className="p-6">
      ...
      <div className="mt-4">
        ...
        <input
          ...
          onChange={(e) =>
            setVoteData({ ...voteData, proposalId: e.target.value })
          }
        />
        <input
          type="text"
        ...
        <input
          type="number"
          placeholder="Tokens Staked"
          onChange={(e) =>
            setVoteData({ ...voteData, tokensStaked: e.target.value })
          }
        />
        <button

  ...
  return (
    <div className="p-6">
      <h2 className="text-2xl font-bold">
        ⚖️ AI-Powered Legal Compliance Check
      </h2>
      <form className="mt-4 space-y-3" onSubmit={handleSubmit}>
        ...
        <input
          ...
          placeholder="Compliance Score (1-100)"
      ...
      {complianceResult && (
        <div className="mt-4 border p-4 rounded">
          <p>
            <strong>Country:</strong> {complianceResult.country}
          </p>
          <p>
          ...
          <p>
            <strong>Risk Assessment:</strong> {complianceResult.risk_assessment}
          </p>
        </div>
      )}
    </div>

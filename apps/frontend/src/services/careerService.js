...
export const getCareerPrediction = async (jobTitle, experience) => {
    try {
        const response = await axios.post(`${API_URL}/predict`, { job_title: jobTitle, experience });
...
export const getSalaryForecast = async (jobTitle, location) => {
    try {
        const response = await axios.post(`${API_URL}/salary_forecast`, { job_title: jobTitle, location });
        return response.data;
    } catch (error) {
...
export const getJobDemandForecast = async (jobTitle) => {
    try {
        const response = await axios.post(`${API_URL}/job_demand`, { job_title: jobTitle });
        return response.data;
    } catch (error) {

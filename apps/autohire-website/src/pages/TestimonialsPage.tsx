  ...
  const testimonials = [
    {
      ...
      quote:
        "AutoHire.AI has completely transformed our recruitment process. We have reduced our time-to-hire by 78% while improving the quality of our candidates. The AI-driven matching is incredibly accurate.",
      rating: 5,
    },
    {
      id: 2,
      ...
      quote:
        "As a fast-growing startup, finding the right talent quickly is crucial. AutoHire.AI has been a game-changer for us, helping us build our team with precision and efficiency.",
      rating: 5,
    },
    {
      id: 3,
      ...
      quote:
        "The automated skill assessments have been invaluable in objectively evaluating candidates. We have seen a significant reduction in turnover since implementing AutoHire.AI.",
      rating: 4,
    },
    {
      id: 4,
      ...
      quote:
        "The analytics provided by AutoHire.AI have given us unprecedented insights into our recruitment process. We have been able to identify and eliminate bottlenecks we did not even know existed.",
      rating: 5,
    },
    {
      id: 5,
      ...
      quote:
        "The bias elimination features have helped us build a more diverse team. The ROI on AutoHire.AI has been exceptional - we have reduced our recruitment costs by over 60%.",
      rating: 5,
    },
    {
      id: 6,
      ...
      quote:
        "The customer support team at AutoHire.AI is exceptional. They have been with us every step of the way, ensuring we get the most out of the platform.",
      rating: 4,
    },
  ];
  ...
  const caseStudies = [
    {
      ...
      challenge:
        "Struggling with high volume of applications and long time-to-hire for technical positions.",
      solution:
        "Implemented AutoHire.AI with custom skill assessments and AI-driven matching.",
      results: [
    ...
    },
    {
      ...
      challenge:
        "High turnover rates and difficulty finding candidates who were a good cultural fit.",
      solution:
        "Used AutoHire.AI's video interview analysis and cultural fit assessment tools.",
      results: [
    ...
    },
    {
      ...
      challenge:
        "Needed to build a diverse team while maintaining high standards for specialized healthcare roles.",
      solution:
        "Leveraged AutoHire.AI's bias elimination features and specialized healthcare skill assessments.",
      results: [
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <motion.p variants={itemVariants} className="text-xl text-gray-300">
              Discover how AutoHire.AI is transforming recruitment processes for
              companies worldwide.
            </motion.p>
          </div>
        </div>
      ...
      >
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              Experience the AutoHire.AI difference and transform your

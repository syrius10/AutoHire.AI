  ...
  const features = [
    {
      ...
      description: 'Our proprietary algorithm analyzes thousands of data points to match candidates with job requirements with unprecedented accuracy.',
    ...
    },
    {
      ...
      description: 'Customizable assessments that objectively evaluate candidate skills and provide insights into their capabilities.',
    ...
    },
    {
      ...
      description: 'AI-powered analysis of video interviews to identify key traits, skills, and cultural fit indicators.',
    ...
    },
    {
      ...
      description: 'Deep insights into your recruitment process with actionable recommendations for improvement.',
    ...
    },
    {
      ...
      description: 'Advanced algorithms designed to identify and eliminate unconscious bias throughout the hiring process.',
    ...
    },
    {
      ...
      description: 'Automate repetitive tasks like screening, scheduling, and follow-ups to focus on what matters most.',
    ...
    },
    {
      ...
      description: 'Create a seamless, engaging experience for candidates throughout the recruitment process.',
    ...
    },
    {
      ...
      description: 'State-of-the-art security measures to protect sensitive candidate and company data.',
  ...
  const steps = [
    {
      ...
      description: 'Our AI analyzes your job descriptions and requirements to understand the skills, experience, and qualities needed.',
      icon: <Layers className="w-10 h-10 text-blue-400" />,
    },
    {
      id: 2,
      title: 'Candidate Matching',
      description: 'The system processes candidate profiles and matches them to your requirements using our proprietary algorithm.',
      icon: <Cpu className="w-10 h-10 text-purple-400" />,
    },
    {
      id: 3,
      title: 'Automated Assessments',
      description: 'Qualified candidates receive customized skill assessments to objectively evaluate their capabilities.',
      icon: <CheckCircle className="w-10 h-10 text-green-400" />,
    },
    {
      id: 4,
      title: 'Video Interview Analysis',
      description: 'AI analyzes video interviews to identify key traits, communication skills, and cultural fit indicators.',
      icon: <VideoIcon className="w-10 h-10 text-pink-400" />,
    },
    {
      id: 5,
      title: 'Data-Driven Decisions',
      description: 'Comprehensive analytics help you make informed hiring decisions based on objective data.',
    ...
    <div className="pt-20">
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-3xl mx-auto text-center">
            ...
            >
              ...
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-purple-500"> Modern Recruitment</span>
            </motion.h1>
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature) => (
              ...
              >
                <div className={`bg-gradient-to-r from-${feature.color}-500/20 to-${feature.color}-600/10 p-6`}>
                  <div className="mb-4">{feature.icon}</div>
                  <h3 className="text-xl font-semibold mb-2 text-white">{feature.title}</h3>
                  <p className="text-gray-300">{feature.description}</p>
                </div>
                <div className="p-6">
                  <h4 className="text-sm font-semibold text-gray-400 mb-3 uppercase">Key Capabilities</h4>
        ...
        <div className="container mx-auto px-4 md:px-6">
          <motion.div variants={itemVariants} className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-gray-300">
              Our platform streamlines your recruitment process from start to finish with advanced AI technology.
            </p>
          </motion.div>
      ...
      >
        <div className="container mx-auto px-4 md:px-6">
          <motion.div variants={itemVariants} className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl font-bold mb-4">
              Traditional Recruitment vs <span className="text-blue-400">AutoHire.AI</span>
            </h2>
            <p className="text-gray-300">
              See how our AI-powered platform compares to traditional recruitment methods.
            </p>
          </motion.div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2">
              <div className="p-8 border-b md:border-b-0 md:border-r border-slate-700/50">
                <div className="flex items-center mb-6">
                  ...
                  <h3 className="text-xl font-semibold text-gray-300">Traditional Recruitment</h3>
                </div>
              ...
              <div className="p-8 bg-gradient-to-br from-blue-900/20 to-purple-900/20">
                <div className="flex items-center mb-6">
                  ...
                  <h3 className="text-xl font-semibold text-white">AutoHire.AI</h3>
                </div>
                <ul className="space-y-4">
                  {comparisonData.autohire.map((item, i) => (
                    <li key={i} className="flex items-start">
